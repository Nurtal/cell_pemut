...
- [ ] sauvegarde automatique des figures générées (avec et sans chiffres)
- [ ] Add column dans les matrice file (pardois l'index est pas là, ie same que nm des cols, ie noms ds pops)
